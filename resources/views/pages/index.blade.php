...
@section('content')
    ...
    <div class="wrapper section section__pizzas">
                    ...
                    @foreach($customPizzas as $customPizza)
                        <div class="section__pizza-card">
                            <a href="pizza/{{ $customPizza->slug }}">
                                ...
                                <img class="pizza-card__image" src="{{ asset('images/pizzas/'. $customPizza->image) }}" alt="{{ $customPizza->name }}">
        ...
        @else
            <p class="small-text section__text">You are not authorised to access this page.</p>
        @endauth
